...
public class BarbershopGui extends JFrame implements Constants, Gui, ChangeListener {
	...
	public void startSimulation() {
		...
		System.out.println("created dorman");
		doorman.startThread();
		System.out.println("started doorman");
		barbers = new Barber[NOF_BARBERS];
		for(int i = 0; i < NOF_BARBERS; i++) {
			barbers[i] = new Barber(queue, this, i);
			System.out.println("created barber");
			barbers[i].startThread();
			System.out.println("started barber");
		}
		System.out.println("finished startSimulation");
	}
